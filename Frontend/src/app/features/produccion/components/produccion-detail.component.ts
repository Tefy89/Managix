...
export class ProduccionDetailComponent implements OnInit, OnDestroy {
 ...
 id=''; orden?:OrdenProduccion; etapas:OrdenProduccionEtapa[]=[]; etapa?:OrdenProduccionEtapa; evidencias:EvidenciaVista[]=[]; revisiones:RevisionEtapa[]=[]; observacion=''; descripcion=''; archivo?:File; preview?:string; mensaje=''; cargando=true; guardando=false; checks=[false,false,false]; modal:''|'iniciar'|'completar'=''; visor?:string;
